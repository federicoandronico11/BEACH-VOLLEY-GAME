...
def aggiorna_database_storico(nome_atleta, pf, ps, sv, sp, vittorie, piazzamento):
    """Salva i dati analitici nel profilo permanente dell'atleta."""
...
def chiudi_torneo_atleta(nome_atleta):
    """Incrementa il contatore tornei giocati."""
...
def registra_incasso_torneo(teams):
    """Salva l'incasso nel registro cassa."""
...
def assegna_punti_finali(teams):
    """Assegna punti ranking basati sulla posizione finale."""
    n = len(teams)
